...
import {PopoverBaseDirective} from "./popper-base.directive";
import {Directive, ElementRef, EventEmitter, HostListener, OnDestroy, OnInit, Output, Renderer2, ViewContainerRef} from "@angular/core";
